...
import { Game1, Game2, PieChart, WordCloud, AboutTheAuthor, MultimodalGame } from './editorComponents';
...
CMS.registerEditorComponent(MultimodalGame);

CMS.registerEditorComponent(AboutTheAuthor);
